...
namespace AventStack.ExtentReports.Tests.APITests
{
    ...
    public class TestInitializeWithNullValues : Base
    {
        ...
        private void nodeNameNull()
        {
            ...
            Assert.Equals(test.GetModel().NodeContext().Count, 0);
            Assert.Null(node);
        }
        ...
        public void TestDescriptionNull()
        {
            ...
            Assert.True(string.IsNullOrEmpty(test.GetModel().Description));
        }
        ...
        public void nodeDescriptionNull()
        {
            ...
            Assert.True(string.IsNullOrEmpty(node.GetModel().Description));
        }
    }
}
